...
function AddEmployment(props) {
  ...
  const onSubmit = (data) => {
    ...
    if (props.keyD === "Edit") {
      axios
        .post(
          `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/editEmployement`,
          {
            obj: {
              ...data,
              startDate,
      ...
      axios
        .post(
          `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/addEmployment`,
          {
            obj: {
              ...data,
              startDate,
            ...
            </p>
            {
              <>
                ...
                <p className="grey-text">
                  Note: if you are currently working in this company then click
                  on the checkbox given below
                </p>
                <FormGroup>
                  <FormControlLabel
                    control={
