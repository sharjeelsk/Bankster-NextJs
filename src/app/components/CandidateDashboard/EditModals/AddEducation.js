...
function AddEducation(props) {
  ...
  const [featuredEducation, setFeaturedEducation] = useState(false);
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/admin/getEducationJobParam`
      )
      .then((res) => {
        console.log(res);
  ...
  const onSubmit = (data) => {
    ...
    if (singleEducation) {
      if (props.keyD === "Edit") {
        axios
          .post(
            `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/editEducation`,
            {
              obj: {
                ...data,
        ...
        axios
          .post(
            `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/addEducation`,
            {
              obj: {
                ...data,
                name: singleEducation.name,
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          /> */}
                ...
                <p className="grey-text">
                  Note: if you are pursuing your education then click on the
                  checkbox given below
                </p>
                ...
                <FormGroup>
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        checked={featuredEducation}
                        onChange={(e) => setFeaturedEducation(e.target.checked)}
                      />
                    }
                    label="Featured Education"
                  />
                </FormGroup>
              </>
            }
