...
function AddSkillPreferences(props) {
  ...
  const onSubmit = (data) => {
    ...
    if (props.keyD === "Add Skill") {
      ...
      axios
        .post(
          `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/addKeySkill`,
      ...
      axios
        .post(
          `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/addPreference`,
