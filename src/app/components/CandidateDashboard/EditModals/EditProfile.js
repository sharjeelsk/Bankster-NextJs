...
function EditProfile(props) {
  ...
  useEffect(() => {
    ...
    setFormValues({
      ...
      city: userInfo.userLocation.city,
      product: userInfo.product,
      noticePeriod: userInfo.noticePeriod,
    });
    setDob(userInfo.dob);
    var config = {
      method: "get",
    ...
    axios
      .get(
        `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/admin/getAllProdIndFunc`,
        {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post(
        `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/editCandidateProfile`,
        {
          ...data,
          dob,
          userLocation: { ...formValues, country: "India" },
          gender,
