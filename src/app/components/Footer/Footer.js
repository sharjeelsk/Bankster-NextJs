      ...
      <section className="footer-main row m-auto">
        ...
        <div className="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7 content row m-auto">
          <div className="col-4">
            ...
            <Link className="link" href="/privacypolicy">
              Privacy Policy
            </Link>
          ...
          <div className="col-4">
            ...
            <Link className="link" href="/refundpolicy">
              Refund Policy
            </Link>
            <Link className="link" href="/contactus">
              Contact Us
            </Link>
            <Link className="link" href="/findjobs">
              Find Jobs
            </Link>
          </div>
          <div className="col-4">
            <Link className="link" href="/findcandidates">
              Find Candidates
            </Link>
            <Link className="link" href="/signup">
              Candidate SignUp
            </Link>
            <Link className="link" href="/SignupRecruiter">
              Recruiter SignUp
            </Link>
        ...
        <div className="bottom-footer col-10 row m-auto align-items-center">
          ...
          <div className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
            <IconButton
              onClick={() =>
                window.open("https://www.facebook.com/banksterindia/", "_blank")
              }
            >
              <FacebookIcon />
            </IconButton>
            <IconButton
              onClick={() =>
                window.open(
                  "https://www.linkedin.com/company/banksterindia/mycompany/",
                  "_blank"
                )
              }
            >
            ...
            <IconButton
              onClick={() =>
                window.open("https://twitter.com/Bankster_India/", "_blank")
              }
            >
              <TwitterIcon />
            </IconButton>
