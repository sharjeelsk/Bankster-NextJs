...
function FilterMenu(props) {
  ...
  useEffect(() => {
    axios
      .post(
        `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/admin/getNamedJobParam`,
        {
          ...limit,
        }
      )
  ...
  const handleSearch = () => {
    axios
      .post(
        `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/job/filterJobs`,
        {
          ...
          functionalArea:
            formValues.functionalArea.length > 0
  ...
  const renderContent = () => {
    return (
      <div className="content">
                  ...
                  <Checkbox
                    onChange={() => {
                      if (formValues.industry.includes(item.name)) {
                        setFormValues({
                          ...formValues,
                          industry: formValues.industry.filter(
                            (i) => i !== item.name
                          ),
                        });
                      } else {
                        setFormValues({
                          ...formValues,
                          industry: [...formValues.industry, item.name],
                        });
                      }
                    }}
                  />
        ...
        <Button
          onClick={() => setLimit({ ...limit, limit1: limit.limit1 + 5 })}
        >
          Load More
        </Button>
        <hr />
                  ...
                  <Checkbox
                    onChange={() => {
                      if (formValues.product.includes(item.name)) {
                        setFormValues({
                          ...formValues,
                          product: formValues.product.filter(
                            (i) => i !== item.name
                          ),
                        });
                      } else {
                        setFormValues({
                          ...formValues,
                          product: [...formValues.product, item.name],
                        });
                      }
                    }}
                  />
        ...
        <Button
          onClick={() => setLimit({ ...limit, limit2: limit.limit2 + 5 })}
        >
          Load More
        </Button>
        <hr />
                  ...
                  <Checkbox
                    onChange={() => {
                      if (formValues.functionalArea.includes(item.name)) {
                        setFormValues({
                          ...formValues,
                          functionalArea: formValues.functionalArea.filter(
                            (i) => i !== item.name
                          ),
                        });
                      } else {
        ...
        <Button
          onClick={() => setLimit({ ...limit, limit3: limit.limit3 + 5 })}
        >
          Load More
        </Button>
        <hr />
        ...
        <FormGroup>
          {cities &&
            cities.slice(0, limit.limit4).map((item, index) => (
              <FormControlLabel
                control={
                  <Checkbox
                    onChange={() => {
                      if (formValues.cities.includes(item)) {
                        setFormValues({
                          ...formValues,
                          cities: formValues.cities.filter((i) => i !== item),
                        });
                      } else {
                        setFormValues({
                          ...formValues,
                          cities: [...formValues.cities, item],
                        });
                      }
                    }}
                  />
        ...
        <Button
          onClick={() => setLimit({ ...limit, limit4: limit.limit4 + 5 })}
        >
          Load More
        </Button>
        <hr />
  ...
  return (
    <div className="filter-menu shadow-sm">
      ...
      <div className="display-desktop">{renderContent()}</div>
    </div>
  );
}
