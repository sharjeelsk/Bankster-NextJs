...
function CreateSubRecruiter(props) {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post(
        `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/recruiter/createSubRecruiter`,
        { ...data, headRecruiter },
      ...
      .then((res) => {
        ...
        props.setSnackbar({
          type: "success",
          text: `${data.fullName} Created Successfully!`,
          open: true,
        });
        router.push("/SubRecruiters");
      })
      .catch((err) => {
        console.log(err);
    ...
    <>
      ...
      <div className="row">
        ...
        >
          ...
          {props.user.userInfo.availablePlanCredits.subRecruiters > 0 ? (
            <section className="create-sub-rec">
