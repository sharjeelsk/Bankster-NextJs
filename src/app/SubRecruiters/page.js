...
import "../style/SubRecruiters.scss";
...
function SubRecruiters(props) {
  ...
  useEffect(() => {
    axios
      .get(
        `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/recruiter/getUserSubRecruiters`,
            ...
            <>
              ...
              >
                <Tooltip title="Add Services">
                  <Fab
                    variant="extended"
                    onClick={() => router.push("/createsubrecruiter")}
                    color="primary"
                    aria-label="add"
                  >
                    <AddIcon sx={{ mr: 1 }} />
...
const columns2 = [
  ...
  //{ field: 'brand', headerName: 'Brand Name',valueGetter:(param)=>param.value.name,width:150},
  {
    field: "fullName",
    headerName: "Name",
    valueGetter: (param) => param.row.fullName,
    width: 150,
  },
  {
    field: "email",
  ...
  },
  {
    field: "mobileNo",
    headerName: "mobileNo",
    valueGetter: (param) => param.row.mobileNo,
    width: 150,
  },
  {
    field: "hiringRate",
    headerName: "Hiring Rate",
    valueGetter: (param) => param.row.hiringRate,
    width: 150,
  },
  {
    field: "companyName",
    headerName: "Company Name",
    valueGetter: (param) => param.row.companyName,
    width: 150,
  },
  {
    field: "designation",
    headerName: "Designation",
    valueGetter: (param) => param.row.designation.toString(),
    width: 150,
  },
  {
    field: "createdAt",
