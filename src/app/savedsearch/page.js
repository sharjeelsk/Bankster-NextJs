...
function Bookmark(props) {
  ...
  const fetchSearches = () => {
    axios
      .get(
        `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/recruiter/getSavedSearch`,
...
const columns2 = [
  ...
  //{ field: 'brand', headerName: 'Brand Name',valueGetter:(param)=>param.value.name,width:150},
  {
    field: "title",
    headerName: "Title",
    valueGetter: (param) => param.row.title,
    width: 150,
  },
  {
    field: "must",
    headerName: "Must",
    valueGetter: (param) => param.row.must.map((item) => item),
    width: 150,
  },
  {
    field: "mustNot",
    headerName: "Exclude",
    valueGetter: (param) => param.row.mustNot.map((item) => item),
    width: 200,
  },
  {
    field: "should",
    headerName: "Any",
    valueGetter: (param) => param.row.should.map((item) => item),
    width: 200,
  },
  {
    field: "age",
    headerName: "Age",
    valueGetter: (param) => `${param.row.minimumAge} | ${param.row.maximumAge}`,
    width: 100,
  },
  {
    field: "experience",
    ...
    valueGetter: (param) =>
      `${param.row.minimumExperience} | ${param.row.maximumExperience}`,
    width: 100,
  },
  {
    field: "ctc",
    headerName: "CTC",
    valueGetter: (param) =>
      `${param.row.minimumSalary} | ${param.row.maximumSalary}`,
    width: 150,
  },
  {
    field: "ug",
    headerName: "UG",
    valueGetter: (param) => param.row.ug,
    width: 150,
  },
  {
    field: "pg",
    headerName: "PG",
    valueGetter: (param) => param.row.pg,
    width: 150,
  },
  {
    field: "noticePeriod",
    headerName: "Notice Period",
    valueGetter: (param) => param.row.noticePeriod,
    width: 150,
  },
  {
    field: "gender",
    headerName: "Gender",
    valueGetter: (param) => (param.row.gender ? param.row.gender : "All"),
    width: 150,
  },
