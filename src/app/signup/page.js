...
function SignUp(props) {
  ...
  const [allFunctionalArea, setAllFuncationalArea] = useState([]);
  const [allProducts, setAllProducts] = useState([]);
  const [allIndustry, setAllIndustry] = useState([]);
  const [singleEducation, setSingleEducation] = useState(null);
  ...
  const onSubmit = (data) => {
    ...
    if (!Array.isArray(resume)) {
      ...
      axios
        .post(
          `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/upload-resume`,
          formdata,
          {
            headers: {
        ...
        .then((res) => {
          ...
          axios
            .post(
              `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/sendVerificationToken`,
              {
                email: data.email,
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/job/getJobTotal`
      )
      .then((res) => {
        console.log(res);
    ...
    axios
      .get(
        `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/recruiter/getSearchCandidateData`
      )
      .then((res) => {
        console.log(res);
      ...
      <section className="row m-auto sign-up-section">
        <div className="col-4 left-content display-desktop">
          <h1 className="main-head">
            Get Access to <span className="primarycolorwh">{jobTotal}</span>{" "}
            Jobs
          </h1>
          <h5>By Registering On Our Platform </h5>
          <img src="/login.png" alt="" className="logimg" />
          <p style={{ lineHeight: 1.8 }} className="grey-text">
            Looking for your dream job? Register on our job site today and
            receive personalized job recommendations based on your skills and
            experience. Our advanced matching algorithm ensures you get the best
            job opportunities that fit your profile. With our user-friendly
            interface, creating a profile and applying to jobs has never been
            easier. Join our community of job seekers today and let us help you
          ...
          <section class="job-benefits">
            ...
            <ul>
              <li>
                Connect with millions of job opportunities in the financial
                sector
              </li>
              <li>
                Find remote job opportunities in finance that allow you to work
                from anywhere
              </li>
              <li>
                Get help with your job search from career counseling and other
                services
              </li>
              <li>
                Discover tools for employers to make the hiring process more
                efficient and effective
              </li>
              <li>
                Experience more personalized job search results with AI and
        ...
        <div className="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 right-content">
          <form className="shadow" onSubmit={handleSubmit(onSubmit)}>
            <h2>Personal Info</h2>
            <p className="grey-text tagline">
              Unlocking potential and driving growth through passion,
            ...
            <section className="row m-auto">
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <p style={{ textAlign: "right" }}>
                  {" "}
                  <Link href="/forgetpassword?candidate">
                    Forget Password
                  </Link>{" "}
                </p>
                ...
                <div className="my-4">
                  <Autocomplete
                    fullWidth
                    value={
                      formValues.noticePeriod ? formValues.noticePeriod : ""
                    }
                    ...
                    renderInput={(params) => (
                      <TextField {...params} label="Choose Notice Period" />
                    )}
                  />
                </div>
              </div>
            ...
            <h2>Location</h2>
            <p className="grey-text tagline">
              Where you are matters - let us help you find your ideal location.
            </p>
            <section className="row m-auto">
            ...
            <h2>Education</h2>
            <p className="grey-text tagline">
              Unlock your potential - tell us about your educational journey.
            </p>
            <section className="row m-auto">
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 my-2">
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField {...params} label="Degree Name" />
                  )}
                />
              </div>
            ...
            <p className="grey-text tagline">
              Your experience matters - share your career journey with us.
            </p>
            <FormControl>
              <FormLabel id="demo-radio-buttons-group-label">
              ...
              >
                <FormControlLabel
                  value={"false"}
                  control={<Radio />}
                  label="I'm Experienced (have work experience)"
                />
                <FormControlLabel
                  value={"true"}
                  control={<Radio />}
                  label="I'm Fresher (haven't worked after grad"
                />
              </RadioGroup>
            </FormControl>
              ...
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <div className="my-4">
                  <Autocomplete
                    ...
                    getOptionLabel={(option) => option.name}
                    renderInput={(params) => (
                      <TextField {...params} label="Select Industry" />
                    )}
                  />
                </div>
                <div className="my-4">
              ...
              <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                ...
                <div className="my-4">
                  <Autocomplete
                    ...
                    disabled={radio === "true" ? true : false}
                    value={
                      formValues.functionalArea
                        ? { name: formValues.functionalArea }
                        : { name: "" }
                    }
                    onChange={(event, newValue) => {
                      if (newValue) {
                    ...
                    getOptionLabel={(option) => option.name}
                    renderInput={(params) => (
                      <TextField {...params} label="Select Functional Area" />
                    )}
                  />
                </div>
              </div>
            ...
            <div className="my-3" style={{ textAlign: "center" }}>
              <Link href="/login" style={{ color: "#ff3d8b" }}>
            ...
            >
              {" "}
              <Link href="/SignupRecruiter" style={{ color: "#ff3d8b" }}>
                {" "}
