  ...
  return (
    <div>
      ...
      <div className="page-section">
        ...
        <p>
          <b>BanksterIndia</b> collects and uses Users personal information for
          the following purposes:
        </p>
        <ul>
          <li>
            <b>To personalize user experience:</b> We may use information in the
            aggregate to understand how our Users as a group use the services
            and resources provided on our Site.
          </li>
          <li>
            <b>To improve our Site:</b> We continually strive to improve our
            website offerings based on the information and feedback we receive
            from you.
          </li>
          <li>
            <b>To improve customer service:</b> Your information helps us to
            more effectively respond to your customer service requests and
            support needs.
          </li>
          <li>
            <b>To process transactions:</b> We may use the information Users
            provide about themselves when placing an order only to provide
            service to that order. We do not share this information with outside
            parties except to the extent necessary to provide the service by our
            registered and premium members.
          </li>
          <li>
            <b>
          ...
          <li>
            ...
            The email address Users provide for registering with WorkIndia.in,
            will only be used to send them information and updates pertaining to
            their order. It may also be used to respond to their inquiries,
            and/or other requests or questions. If User decides to opt-in to our
            mailing list, they will receive emails that may include company
            news, updates, offers, related product or service information, etc.
            If at any time the User would like to unsubscribe from receiving
            future emails, they can submit unsubscribe request. We&apos;ve
        ...
        <p>
          ...
          Site. We have physical, electronic, and procedural safeguards that
          comply with the laws prevalent in India to protect personal
          information about you. We seek to ensure compliance with the
          requirements of the Information Technology Act, 2000 as amended and
          rules made thereunder to ensure the protection and preservation of
          your privacy.
        </p>
        <p>
          <b>
            UNLESS YOU REQUEST THAT WE DELETE CERTAIN INFORMATION, WE RETAIN THE
            INFORMATION WE COLLECT FOR AT LEAST 5 YEARS AND MAY RETAIN THE
            INFORMATION FOR AS LONG AS NEEDED FOR OUR BUSINESS AND LEGAL
            PURPOSES.
          </b>
        </p>
        ...
        <p>
          ...
          about you with other persons (save with your consent) or
          non-affiliated companies except to provide services you have
          requested, when we have your permission or under the following
          circumstances.
        </p>
        <ul>
          <li>
            We provide the information to trusted partners who work on behalf of
            or with us under confidentiality agreements. These companies may use
            your personal information to help us communicate with you about our
            offers and our marketing partners. However, these companies do not
        ...
        <p>
          We share sensitive personal information to any third party without
        ...
        <ul>
          ...
          <li>
            When we respond to subpoenas, court orders, or legal process, or to
        ...
        <p>
          ...
          disclosure is reasonably necessary for enforcing the Privacy Policy
          and for complying with the applicable laws and regulations.
        </p>

        <h2>THIRD PARTY WEBSITES</h2>
        <p>
          Users may find advertising or other content on our Site that link to
          the sites and services of our partners, institutes, advertisers,
          sponsors and other third parties. We do not control the content or
        ...
        <h2>SECURITY</h2>
        <p>
          <b>BanksterIndia</b> takes industry standard protocols and technology
          to protect registered user information. <b>BanksterIndia</b> also
          protects registered user information offline. All registered user
          information is restricted within our offices. Servers used to store
          personally identifiable information are housed in a secure, supervised
          environment. In addition, only our employees who need specific
          information to perform a task are granted access to personally
          identifiable information. <b>BanksterIndia</b> takes commercially
          reasonable steps to help protect and secure the information it
          collects and stores about our Users.
        </p>

        <p>
          All access to the Site is encrypted using industry-standard transport
          layer security technology (TLS). When you enter sensitive information
          (such as tax identification number), we encrypt the transmission of
          that information using secure socket layer technology (SSL). We also
          use HTTP strict transport security to add an additional layer of
          protection for our Users. But remember that no method of transmission
          over the Internet, or method of electronic storage, is 100% secure.
          Thus, while we strive to protect your personal data, we cannot ensure
          and do not warrant the security of any information you transmit to us.
          ...
          information (including sensitive personal information). Our security
          procedures mean that we may occasionally request proof of identity
          before we disclose personal information to you. It is important for
          ...
          computer. Click here for more information on how to sign off.
        </p>
