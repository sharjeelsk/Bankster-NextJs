...
import PersonalInfoEdit from "../components/CandidateDashboard/EditModals/PersonalInfoEdit";
import AddEmployment from "../components/CandidateDashboard/EditModals/AddEmployment";
import AddEducation from "../components/CandidateDashboard/EditModals/AddEducation";
import AddSkillPreferences from "../components/CandidateDashboard/EditModals/AddSkillPreferences";
import EditProfile from "../components/CandidateDashboard/EditModals/EditProfile";
import EditProfileImage from "../components/CandidateDashboard/EditModals/EditProfileImage";
...
function CandidateHome(props) {
  ...
  useEffect(() => {
    axios
      .get(
        `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/getCandidateProfile`,
  ...
  const upload2 = (e) => {
    ...
    if (!Array.isArray(e.target.files[0])) {
      ...
      axios
        .post(
          `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/upload-candidate-resume`,
          formdata,
          {
            headers: {
  ...
  const renderEmployementString = () => {
    if (userInfo.fresher) {
      ...
      userInfo.workExperience.filter((i) => i.current === true).length > 0
    ) {
            ...
            <>
              ...
              <section className="candidate-info-section row  shadow-sm">
                ...
                <div className="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 info-cont">
                  ...
                  <p className="grey-text">
                    ...
                    {userInfo.currentCtc} CTC | {userInfo.industry} |{" "}
                    {userInfo.functionalArea} | {userInfo.product} |{" "}
                  ...
                  <div className="row m-auto chip-div">
                    {userInfo.skills.length > 0 ? (
                      ...
                      <p style={{ color: "red", fontWeight: "bold" }}>
                        You haven&apos;t added any skills yet, add from the
                ...
                <div className="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 resume-div p-0">
                    ...
                    {userInfo.resume ? (
                      <div className="resume-child row m-auto">
                        ...
                        <div
                          ...
                          onClick={() =>
                            window.open(
                              `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/pdf/${userInfo.resume}`,
                              "_blank"
                            )
                          }
                        >
                          <h4>
                            {userInfo.fullName}&apos;s Resume.
                            {userInfo.resume.split(".")[1]}
                          </h4>
                  ...
                  <div className="row m-auto subs-div align-items-center justify-content-around">
                    <div className="col-8">
                      <h5>
                        Currently on{" "}
                        {userInfo.subscription && userInfo.subscription.name}{" "}
                        Tier
                      </h5>
                      <p>
                        Upgrading plan will result in your profile being
                        displayed on home this will increase your hiring
                        probability
                      </p>
                    </div>
                    <div className="col-4">
                ...
                <section className="row m-auto view-section-head justify-content-around">
                  ...
                  <div className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 view-section-child row m-auto align-items-center justify-content-around shadow-sm">
                    ...
                    <div className="ml-2">
                      <h2>
                        {dashboardData &&
                          dashboardData.totalProfileBookmarks[0].total}
                      </h2>
                    </div>
                  </div>
                  <div className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 view-section-child row m-auto align-items-center justify-content-around shadow-sm">
                    ...
                    <div className="ml-2">
                      <h2>
                        ...
                        isNaN(
                          Math.ceil(
                            (dashboardData.hiredJobs[0].total /
                              dashboardData.appliedJobs[0].total) *
                              100
                          )
                        )
                          ? 0
              ...
              <section className="row m-auto info-sections justify-content-around">
                        ...
                        >
                          ...
                          <IconButton
                            onClick={() => {
                              axios
                                .post(
                                  `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/removeEmployment`,
                                  { obj: item },
                                  { headers: { token: props.user.user } }
                                )
                                .then((res) => {
                          ...
                          <p className="datefromto">
                            ...
                            {item.current
                              ...
                              : moment
                                  ...
                                  .local()
                                  .format("DD/MM/YYYY")}{" "}
                            - {item.featuredEducation ? "Featured" : null}
                          </p>
                        </div>
                        <div
                          className="p-0 col-4"
                        ...
                        >
                          ...
                          <IconButton
                            onClick={() => {
                              axios
                                .post(
                                  `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/removeEducation`,
                                  { obj: item },
                                  { headers: { token: props.user.user } }
                                )
                                .then((res) => {
                  ...
                  {userInfo.skills.map((item, index) => (
                    <Chip
                      ...
                      onDelete={() => {
                        axios
                          .post(
                            `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/removeKeySkill`,
                            { skillName: item },
                            { headers: { token: props.user.user } }
                          )
                          .then((res) => {
                ...
                <div className="col-12 col-sm-12 col-md-5 col-lg-5 col-xl-5 info-child shadow-sm">
                  ...
                  {userInfo.preferences.map((item, index) => (
                    <Chip
                      className="m-2"
                      color="primary"
                      onDelete={() => {
                        axios
                          .post(
                            `${process.env.NEXT_PUBLIC_REACT_APP_DEVELOPMENT}/api/candidate/removePreference`,
                            { preference: item },
                            { headers: { token: props.user.user } }
                          )
                          .then((res) => {
